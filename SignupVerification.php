...
<html lang="en" dir="ltr">
    ...
    <?php
        ...
        */
        $title = "Signup Verification Page";
        include "./session.php";
        include('head.php');
            ...
            <div class="container py-5 h-100">
                ...
                <div class="col-lg-8 col-xl-6">
                    ...
                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-registration/img3.webp"
                        ...
                        alt="Sample photo">-->
                    <div class="card-body">
                        <h3 class="mb-4 pb-2 pb-md-0 px-md-2">يرجى ادخال رمز التفعيل لتاكيد تفعيل حسابك.</h3>
                        <hr>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <input type="submit" name="submit" id= "signup" class="btn btn-success btn-lg mb-1 mx-4" value="تأكيد تفعيل حسابي" />
                            </div>
                            ...
                            <input type="button" name="resend_otp" id= "resend_otp" class="btn btn-primary btn-lg mb-1 mx-4" value="Resend a New OTP Code" />
                            </div>-->
                        </div>
                                    ...
                                    if($conn){
                                        ...
                                        if($otp == $otp_code){
                                            ...
                                            if(mysqli_query($conn,$sql_user_activate)){
                                                ...
                                                echo '<script>alert("Verfiy account done, you may continue regstering now. You are being redirected to the 2nd Signup page.");</script>'; 
                                                echo "<script>window.location.replace('signup-2.php');</script>";

                                            }
                                            else{
                                               // echo "Failed to verify you account";
                                               echo '<script>alert("Failed to verify you account.");</script>'; 
